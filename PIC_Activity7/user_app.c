...
u16 G_au16SongNotes[] =
{
    C4, NN, C4, G4, NN, G4, A4, NN, A4, G4, F4, NN, F4, E4, NN, E4, D4, NN, D4, C4, NN, 
};

u16 G_au16NoteDuration[] =
{
    N4, RT, N4, N4, RT, N4, N4, RT, N4, N2, N4, RT, N4, N4, RT, N4, N4, RT, N4, N2, ST, 1000
};
...
void UserAppRun(void)
{
    ...
    InterruptTimerXus(G_au16SongNotes [u8ArrayIndex], true);
    u16Duration++;
